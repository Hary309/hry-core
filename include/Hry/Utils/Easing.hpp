...
struct Easing final
{
    ...
    static T ElasticEaseInOut(T p)
    {
        ...
        return static_cast<T>(0.5) *
               (sin(-13 * M_PI_2 * ((2 * p - 1) + 1)) * pow(2, -10 * (2 * p - 1)) + 2);
    }
    ...
    static T BounceEaseOut(T p)
    {
        ...
        if (p < 8 / static_cast<T>(11.0))
        {
            return (363 / static_cast<T>(40.0) * p * p) - (99 / static_cast<T>(10.0) * p) +
                   17 / static_cast<T>(5.0);
        }
        if (p < 9 / static_cast<T>(10.0))
        {
            return (4356 / static_cast<T>(361.0) * p * p) - (35442 / static_cast<T>(1805.0) * p) +
                   16061 / static_cast<T>(1805.0);
        }

        return (54 / static_cast<T>(5.0) * p * p) - (513 / static_cast<T>(25.0) * p) +
               268 / static_cast<T>(25.0);
    }
