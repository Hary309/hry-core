...
static const auto BindableKeys = std::array{
    ...
    // Joystick
    BindableKey{ Joystick::Button::Button1, "Joy Btn 1" },
    BindableKey{ Joystick::Button::Button2, "Joy Btn 2" },
    BindableKey{ Joystick::Button::Button3, "Joy Btn 3" },
    BindableKey{ Joystick::Button::Button4, "Joy Btn 4" },
    BindableKey{ Joystick::Button::Button5, "Joy Btn 5" },
    BindableKey{ Joystick::Button::Button6, "Joy Btn 6" },
    BindableKey{ Joystick::Button::Button7, "Joy Btn 7" },
    BindableKey{ Joystick::Button::Button8, "Joy Btn 8" },
    BindableKey{ Joystick::Button::Button9, "Joy Btn 9" },
    BindableKey{ Joystick::Button::Button10, "Joy Btn 10" },
    BindableKey{ Joystick::Button::Button11, "Joy Btn 11" },
    BindableKey{ Joystick::Button::Button12, "Joy Btn 12" },
    BindableKey{ Joystick::Button::Button13, "Joy Btn 13" },
    BindableKey{ Joystick::Button::Button14, "Joy Btn 14" },
    BindableKey{ Joystick::Button::Button15, "Joy Btn 15" },
    BindableKey{ Joystick::Button::Button16, "Joy Btn 16" },
    BindableKey{ Joystick::Button::Button17, "Joy Btn 17" },
    BindableKey{ Joystick::Button::Button18, "Joy Btn 18" },
    BindableKey{ Joystick::Button::Button19, "Joy Btn 19" },
    BindableKey{ Joystick::Button::Button20, "Joy Btn 20" },
    BindableKey{ Joystick::Button::Button21, "Joy Btn 21" },
    BindableKey{ Joystick::Button::Button22, "Joy Btn 22" },
    BindableKey{ Joystick::Button::Button23, "Joy Btn 23" },
    BindableKey{ Joystick::Button::Button24, "Joy Btn 24" },
    BindableKey{ Joystick::Button::Button25, "Joy Btn 25" },
    BindableKey{ Joystick::Button::Button26, "Joy Btn 26" },
    BindableKey{ Joystick::Button::Button27, "Joy Btn 27" },
    BindableKey{ Joystick::Button::Button28, "Joy Btn 28" },
    BindableKey{ Joystick::Button::Button29, "Joy Btn 29" },
    BindableKey{ Joystick::Button::Button30, "Joy Btn 30" },
    BindableKey{ Joystick::Button::Button31, "Joy Btn 31" },
    BindableKey{ Joystick::Button::Button32, "Joy Btn 32" },
};
