...
namespace hry
{
TruckChannelAggregator::TruckChannelAggregator(scs::TruckChannel& truckChannel, scs_telemetry_init_params_v100_t* scsTelemetry, InternalEventDispatcher& dispatcher)
    ...
    , _truck(truckChannel)
{
    ...
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_local_angular_velocity, _truck.localVelocityAngular);
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_local_linear_acceleration, _truck.localAccelerationLinear);
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_local_angular_acceleration, _truck.localAccelerationAngular);
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_cabin_offset, _truck.cabinOffset);
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_cabin_angular_velocity, _truck.cabinVelocityAngular);
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_cabin_angular_acceleration, _truck.cabinAccelerationAngular);
    ...
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_brake_air_pressure_warning, _truck.brakeAirPressureWarning);
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_brake_air_pressure_emergency, _truck.brakeAirPressureEmergency);
    ...
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_fuel_average_consumption, _truck.fuelConsumptionAverage);
    ...
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_adblue_average_consumption, _truck.adBlueConsumptionAverage);
    ...
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_water_temperature_warning, _truck.waterTemperatureWarning);
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_battery_voltage, _truck.batteryVoltage);
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_battery_voltage_warning, _truck.batteryVoltageWarning);
    ...
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_light_aux_front, *reinterpret_cast<uint32_t*>(&_truck.lightAuxFront));
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_light_aux_roof, *reinterpret_cast<uint32_t*>(&_truck.lightAuxRoof));
    ...
    registerChannel(SCS_TELEMETRY_TRUCK_CHANNEL_navigation_speed_limit, _truck.navigationSpeedLimit);
}
...
void TruckChannelAggregator::onHShifterConfig(const std::optional<scs::HShifter>&& hshifter)
{
    ...
    if (newCount > _selectorCount)
    {
        registerIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_hshifter_selector, _selectorCount, newCount, _truck.hshifterSelect);
    }
    else if (newCount < _selectorCount)
    {
        unregisterIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_hshifter_selector, newCount, _selectorCount, _truck.hshifterSelect);
    }
...
{
    registerIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_susp_deflection, startIndex, endIndex, _truck.wheelSuspensionDeflection);
    registerIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_on_ground, startIndex, endIndex, _truck.wheelOnGround);
    registerIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_substance, startIndex, endIndex, _truck.wheelSubstance);
    registerIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_velocity, startIndex, endIndex, _truck.wheelAngularVelocity);
    registerIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_steering, startIndex, endIndex, _truck.wheelSteering);
    registerIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_rotation, startIndex, endIndex, _truck.wheelRotation);
    registerIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_lift, startIndex, endIndex, _truck.wheelLift);
    registerIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_lift_offset, startIndex, endIndex, _truck.wheelLiftOffset);
}

void TruckChannelAggregator::unregisterWheels(int startIndex, int endIndex)
{
    unregisterIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_susp_deflection, startIndex, endIndex, _truck.wheelSuspensionDeflection);
    unregisterIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_on_ground, startIndex, endIndex, _truck.wheelOnGround);
    unregisterIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_substance, startIndex, endIndex, _truck.wheelSubstance);
    unregisterIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_velocity, startIndex, endIndex, _truck.wheelAngularVelocity);
    unregisterIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_steering, startIndex, endIndex, _truck.wheelSteering);
    unregisterIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_rotation, startIndex, endIndex, _truck.wheelRotation);
    unregisterIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_lift, startIndex, endIndex, _truck.wheelLift);
    unregisterIndexedChannel(SCS_TELEMETRY_TRUCK_CHANNEL_wheel_lift_offset, startIndex, endIndex, _truck.wheelLiftOffset);
}
}
