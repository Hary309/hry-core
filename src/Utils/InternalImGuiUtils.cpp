...
void InternalImGuiUtils::ApplyDarkTheme()
{
    ...
    style.Colors[ImGuiCol_WindowBg] = ImVec4(0.13f, 0.14f, 0.15f, 0.94f);
    style.Colors[ImGuiCol_ChildBg] = ImVec4(0.13f, 0.14f, 0.15f, 0.00f);
    ...
    style.Colors[ImGuiCol_CheckMark] = ImVec4(0.92f, 0.69f, 0.11f, 1.00f);
    style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.92f, 0.70f, 0.11f, 1.00f);
    style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.72f, 0.55f, 0.08f, 1.00f);
